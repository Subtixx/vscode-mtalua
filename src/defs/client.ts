...
tmpDef.args = ["int width"," int height ["," string pathOrRawdata"," function callback ( element svg ) ]"];
tmpDef.argDescs = {};
tmpDef.scriptSide = ScriptSide.Client;
ClientDefinitions.push(tmpDef);
...
tmpDef.returnType = "bool";
tmpDef.args = ["svg svgElement"," xmlnode xmlDocument ["," function callback ( element svg ) ]"];
tmpDef.argDescs = {};
tmpDef.scriptSide = ScriptSide.Client;
ClientDefinitions.push(tmpDef);
...
tmpDef.returnType = "bool";
tmpDef.args = ["svg svgElement"," int width"," int height ["," function callback ( element svg ) ]"];
tmpDef.argDescs = {};
tmpDef.scriptSide = ScriptSide.Client;
ClientDefinitions.push(tmpDef);
...
tmpDef = new MTAFunction;
tmpDef.label = "svgGetUpdateCallback";
tmpDef.description = "Gets the update callback of an svg element.";
...
tmpDef = new MTAFunction;
tmpDef.label = "svgSetUpdateCallback";
tmpDef.description = "Sets the update callback of an svg element.";
tmpDef.returnType = "bool";
tmpDef.args = ["svg svgElement"," function / bool callback"];
tmpDef.argDescs = {};
tmpDef.scriptSide = ScriptSide.Client;
ClientDefinitions.push(tmpDef);